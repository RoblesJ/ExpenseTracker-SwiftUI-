...
extension Category {
    ...
    static let moviesAndDVDs = Category(id: 301, name: "Movies and DVDs", icon: .file, mainCategoryId: 3)
    ...
    static let sofware = Category(id: 801, name: "Software", icon: .icons, mainCategoryId: 8)
